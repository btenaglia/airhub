    ...
    angular.module('app')
        .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
            ...
            .state('places-edit', {
                ...
                resolve: {
  					place: ['$stateParams', 'placesFactory', function($stateParams, factory) {
        ...
        .state('members-notification',{
          ...
          members: ['membersFactory', function(factory){
		    ...
		    .state('profiles-add', {
                ...
                resolve: {
  					profile: ['profilesFactory', function(factory){
    					return factory.getAll();
  					}]
				}
		    })
            ...
            .state('profiles-edit', {
                ...
                resolve: {
  					profile: ['$stateParams', 'profilesFactory', function($stateParams, factory) {
                        return factory.get($stateParams.id);
                    }]	
				}
		    })
            ...
            .state('profiles-viewAll', {
                ...
                resolve: {
  					profiles: ['profilesFactory', function(factory){
    					return factory.getAll();
  					}]		
				}
		    })
            ...
            .state('planes-edit', {
                ...
                resolve: {
  					plane: ['$stateParams', 'planesFactory', function($stateParams, factory) {
                        return factory.get($stateParams.id);
                    }]	
				}
		    })
            ...
            .state('planes-viewAll', {
                ...
                resolve: {
  					planes: ['planesFactory', function(factory){
    					return factory.getAll();
  					}]		
				}
		    })
            ...
            .state('flights-add', {
                ...
                resolve: {
                    ...
                    status: ['statusFactory', function(factory){
            ...
            .state('flights-edit', {
                ...
                resolve: {
  					flight: ['$stateParams', 'flightsFactory', function($stateParams, factory) {
                        return factory.get($stateParams.id);
                    }],
                    places: ['placesFactory', function(factory){
    					return factory.getAll();
            ...
            .state('flights-viewAll', {
                ...
                resolve: {
  					flights: ['flightsFactory', function(factory){
    					return factory.getAll();
  					}],
                    planes: ['planesFactory', function(factory){
    					return factory.getAll();
            ...
            .state('bookings-by-flight', {
                ...
                resolve: {
                    ...
                    bookings: ['$stateParams', 'bookingsFactory', function($stateParams, factory) {
            ...
            .state('users-viewAll', {
                ...
                resolve: {
  					users: ['usersFactory', function(factory){
    					return factory.getAll();
  					}]		
				}
		    })
		    ...
		    .state('payments-viewAll', {
                ...
                resolve: {
  					payments: ['paymentsFactory', function(factory){
    					return factory.getAll();
  					}]		
				}
		    })
		    ...
		    .state('setup-edit', {
                ...
                resolve: {
  					setup: ['$stateParams', 'setupFactory', function($stateParams, factory) {
                        return factory.get($stateParams.id);
                    }]	
				}
		    })
