(function () {
    ...
    .controller('AddUserController' , function ($scope, $rootScope, $controller, usersFactory) {
        ...
        $scope.submitForm = function(){
            $scope.doHttp(usersFactory.create, 'New user added successfully').error(function(data,status){
                if (status === 409){
    ...
    .controller('EditUserController' , function ($scope, $rootScope, $controller, usersFactory, user) {
    ...
    .controller('ViewAllUsersController' ,function ($scope, $controller, $mdDialog, usersFactory, users) {
